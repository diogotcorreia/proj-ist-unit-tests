...
public class StatusBalanceTest extends PoUILibTest{
    

    public StatusBalanceTest()
    {
        super(true);
    }
    ...
    @Test
    @DisplayName("Parceiro Normal compra vende produto Simples")
    void saleSimpleProductAlongTimeNormal() {
    ...
    @Test
    @DisplayName("Parceiro Selection compra vende produto Simples")
    void saleSimpleProductAlongTimeSelection() {
        super.loadFromInputFile("test041.input");
        this.interaction.addMenuOptions(7, 3);
    ...
    @Test
    @DisplayName("Parceiro Elite compra vende produto Simples")
    void saleSimpleProductAlongTimeElite() {
        super.loadFromInputFile("test041.input");
        this.interaction.addMenuOptions(7, 3);
    ...
    @Test
    @DisplayName("Parceiro Normal compra vende produto Derivado")
    void saleDerivedProductAlongTimeNormal() {
        super.loadFromInputFile("test042.input");
        this.interaction.addMenuOptions(7, 3);
    ...
    @Test
    @DisplayName("Parceiro Selection compra vende produto Derivado")
    void saleDerivedProductAlongTimeSelection() {
        super.loadFromInputFile("test042.input");
        this.interaction.addMenuOptions(7, 3);
        this.interaction.addFieldValues("M1","10", "VIDRO", "1");
        this.interaction.addMenuOptions(5);
    ...
    @Test
    @DisplayName("Parceiro Elite compra vende produto Derivado")
    void saleDerivedProductAlongTimeElite() {
        super.loadFromInputFile("test042.input");
        this.interaction.addMenuOptions(7, 3);
        this.interaction.addFieldValues("M1","10", "VIDRO", "2");
        this.interaction.addMenuOptions(5);
